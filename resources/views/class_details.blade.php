          ...
          <div class="row justify-content-center">
            ...
            <div class="col-lg-8 col-md-6 col-12 card-body">
              <div class="mb-4 text-center py-2">
                <h2 class="fw-bold bg-light card-header">{{$course['classTitle']}}</h2>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Capacity:</span>{{$course['capacity']}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Is_Fulled:</span>{{$course['is_fulled']}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
              ...
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Time From:</span><br>{{$course['time_from']}}
                </p>
              </div>
              <div class="mb-4">
                <p class="card-text">
                  <span class="fw-bold">Time From:</span><br>{{$course['time_to']}}
                </p>
              </div>
