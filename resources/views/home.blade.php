...
<html lang="en">
    <head>
        ...
        <link href="{{asset('assests/css/bootstrap-icons.css')}}" rel="stylesheet">

        <link rel="stylesheet" href="{{asset('assests/css/slick.css')}}"/>

        <link href="{{asset('assests/css/tooplate-little-fashion.css')}}" rel="stylesheet">
<!--
    ...
    <body>
        ...
        <main>
            ...
            <section class="slick-slideshow">   
                ...
                <div class="slick-custom">
                    <img src="{{asset('assests/images/slideshow/team-meeting-renewable-energy-project.jpeg')}}" class="img-fluid" alt="">
                ...
                <div class="slick-custom">
                    <img src="{{asset('assests/images/slideshow/two-business-partners-working-together-office-computer.jpeg')}}" class="img-fluid" alt="">
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="tab-content mt-2" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="{{asset('assests/images/pim-chu-z6NZ76_UTDI-unsplash.jpeg')}}" class="img-fluid" alt="">
                                        </div>
                                ...
                                <div class="tab-pane fade" id="pills-skill" role="tabpanel" aria-labelledby="pills-skill-tab">
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="{{asset('assests/images/cody-lannom-G95AReIh_Ko-unsplash.jpeg')}}" class="img-fluid" alt="">
                                        </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="{{asset('assests/images/retail-shop-owner-mask-social-distancing-shopping.jpg')}}" class="img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                <a href="product-detail.html">
                                    <img src="{{asset('assests/images/'.$product->image)}}" class="img-fluid product-image" alt="{{ $product->title }}">
                                </a>

                                <div class="product-top d-flex">
                                    <span class="product-alert me-auto">{{$product['short_description']}}</span>
        ...
        <script src="{{asset('assests/js/Headroom.js')}}"></script>
        <script src="{{asset('assests/js/jQuery.headroom.js')}}"></script>
        <script src="{{asset('assests/js/slick.min.js')}}"></script>
