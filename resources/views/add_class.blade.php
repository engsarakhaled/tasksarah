      ...
      <div class="bg-light p-5 rounded">
        ...
        <form action="{{route('classes.store')}}" method="post" class="px-md-5">
          ...
          <div class="form-group mb-3 row">
            ...
            <div class="col-md-10">
              <input type="time"  placeholder="Enter price" class="form-control py-2"name="time_from" />
            </div>
          </div>
          <div class="form-group mb-3 row">
            <label for="" class="form-label col-md-2 fw-bold text-md-end">Time to:</label>
            <div class="col-md-10">
              <input type="time"  placeholder="Enter price" class="form-control py-2"name="time_to" />
            </div>
          </div>
